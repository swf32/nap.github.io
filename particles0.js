...
function createParticle() {
    ...
    document.querySelector("#particles_container0").appendChild(svg);
    ...
    const animation = svg.animate([
        {
            ...
            opacity: 0,
            width: `${size * (172/70)}px`,
            height: `${size}px`
        },
        {
            left: `${endX - (size * settings.endSizeRatio * (172/70) / 2)}px`,
            top: `${endY - (size * settings.endSizeRatio / 2)}px`,
            opacity: targetOpacity,
            width: `${size * settings.endSizeRatio * (172/70)}px`,
            height: `${size * settings.endSizeRatio}px`
        },
        {
            left: `${endX - (size * settings.endSizeRatio * (172/70) / 2)}px`,
            top: `${endY - (size * settings.endSizeRatio / 2)}px`,
        ...
        duration: settings.particleLife,
        fill: 'forwards'
    });
